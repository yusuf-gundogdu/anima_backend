...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IMAGEASSET_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_IMAGEASSET actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_IMAGEASSET actions', async () => {
      const arg = { id: 15137 };
    ...
    it('dispatches UPDATE_IMAGEASSET actions', async () => {
      const arg = { id: 15137 };
    ...
    it('dispatches PARTIAL_UPDATE_IMAGEASSET actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_IMAGEASSET actions', async () => {
      const arg = 42666;
