...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERATELIST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GENERATELIST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GENERATELIST actions', async () => {
      const arg = { id: 18876 };
    ...
    it('dispatches UPDATE_GENERATELIST actions', async () => {
      const arg = { id: 18876 };
    ...
    it('dispatches PARTIAL_UPDATE_GENERATELIST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GENERATELIST actions', async () => {
      const arg = 42666;
