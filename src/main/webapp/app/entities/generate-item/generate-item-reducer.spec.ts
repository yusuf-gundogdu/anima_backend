...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERATEITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GENERATEITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GENERATEITEM actions', async () => {
      const arg = { id: 13440 };
    ...
    it('dispatches UPDATE_GENERATEITEM actions', async () => {
      const arg = { id: 13440 };
    ...
    it('dispatches PARTIAL_UPDATE_GENERATEITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GENERATEITEM actions', async () => {
      const arg = 42666;
